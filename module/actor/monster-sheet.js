...
export class OseActorSheetMonster extends OseActorSheet {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      ...
      template: "systems/ldlmde/templates/actors/monster-sheet.html",
      width: 450,
      height: 560,
      resizable: true,
      tabs: [
  ...
  async generateSave() {
    ...
    let templateData = { choices: ["physical", "mental"] },
      dlg = await renderTemplate(
        "/systems/ldlmde/templates/actors/dialogs/monster-saves.html",
        templateData
      );
